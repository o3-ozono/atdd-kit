...
**autopilot mode:** while `autopilot` runs, the autopilot Iron Law (`${CLAUDE_PLUGIN_ROOT}/docs/methodology/autopilot-iron-law.md`, AL-1…AL-6) overrides the conflicting standard laws above; outside autopilot these laws are supreme.
