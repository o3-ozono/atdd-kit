...
| test_running_atdd_cycle_skill.bats | running-atdd-cycle skill (Step 4, ATDD double loop) — #355 F8: impl SHA 4th arg contract in C2 Confirm RED |
| test_reviewing_deliverables_skill.bats | reviewing-deliverables skill (Step 5) — #355 F3-F7: N=3 majority panel / CONVERGED conditions / scope guard / round memory / severity dedup |
