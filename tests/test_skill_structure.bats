...
setup() {
  ALL_SKILLS=(bug autopilot debugging defining-requirements extracting-user-stories launching-preview merging-and-deploying reviewing-deliverables running-atdd-cycle session-start sim-pool skill-fix skill-gate ui-test-debugging writing-design-doc writing-plan-and-tests)
}
