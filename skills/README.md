...
| [autopilot](autopilot/) | On-demand (autopilot) | Autonomous convergence loop over the flow skills — human gates at requirements approval (start), design approval (before ATDD), and merge (end) |
