...
- [x] [green] AT-001: ログ未存在 + 期待行数 0 はガードを通過する
...
- [x] [green] AT-002: 記録済みのはずのログが消えていたら halt する
...
- [x] [green] AT-003: 行数が期待より少ないログは halt する
...
- [x] [green] AT-004: 行数が期待より多いログは halt する
...
- [x] [green] AT-005: expected が空・非数値なら halt する
...
- [x] [green] AT-006: SKILL.md の rails チェックが新ガードを呼んでいる
...
- [x] [green] AT-007: 期待行数の真実が freeze から audit まで一貫して維持される
  - Given: `skills/autopilot/SKILL.md` の Workflow script
...
- [x] [green] AT-008: 既存スイート green の維持
