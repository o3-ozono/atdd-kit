...
- [ ] [planned] AT-001: フォールバック既定値が廃止され、phase ガードが throw する
...
- [ ] [planned] AT-002: 受理される phase 値が `'design'` と `'impl'` の 2 値に限定されている
...
- [ ] [planned] AT-003: 追加した phase ガード pin テストがスイート内で通過する
...
- [ ] [planned] AT-004: Flow 節の design / impl 両 invoke 指示に args 形式注記がある
...
- [ ] [planned] AT-005: phase ガードが FREEZE・イテレーションループより前に位置する
...
- [ ] [planned] AT-006: 変更が script 側ガード + BATS pin + SKILL.md 注記に限定されている
