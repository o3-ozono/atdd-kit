...
- [ ] [planned] AT-318-A1: hand-off 起動は設計 gate でブロックせず merge-ready で手放す（F4）
...
- [ ] [planned] AT-318-A2: 通常起動の3 gate は不変（C3・regression 候補）
...
- [ ] [planned] AT-318-B1: キューの issue を headless worker で merge-ready まで無人到達（F1）
...
- [ ] [planned] AT-318-E1: 壁打ち以外無人で複数 issue が main に統合される（F1・F2・F3・F5）
...
- [ ] [planned] AT-318-E2: 暴走防止 — キュー外 issue に着手しない（C4・regression 候補）
