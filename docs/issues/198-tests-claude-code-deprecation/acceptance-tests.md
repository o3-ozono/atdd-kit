...
- [x] [green] AT-001: tests/claude-code/ directory removed
...
- [x] [green] AT-002: legacy l4 tests removed and renamed
  - **Given:** PR #225 適用後の HEAD
...
- [x] [green] AT-003: no l4 references in tests/
  - **Given:** PR #225 適用後の HEAD
...
- [x] [green] AT-006: skill-e2e dry-run identical before and after
...
- [x] [green] AT-007: terminology grep pass
  - **Given:** PR #225 適用後の HEAD
...
- [x] [green] AT-008: full BATS suite green
  - **Given:** PR #225 適用後の HEAD
...
- [x] [green] AT-010: renamed lint test still green
