...
- [ ] [planned] AT-001: SKILL.md にプレースホルダのハッシュ指示が存在しない
...
- [ ] [planned] AT-002: audit プロンプトが findings 実テキストをハッシュする手順を持つ
...
- [ ] [planned] AT-003: review プロンプトが design phase で計画成果物のみをスコープにする
...
- [ ] [planned] AT-004: extracting-user-stories ステップのレビューが当該ステップ成果物に限定される
...
- [ ] [planned] AT-005: iteration 2 以降の gen プロンプトに前回 findings 本文が含まれる
...
- [ ] [planned] AT-006: BATS がプレースホルダ定数 fingerprint の再発を防ぐ
