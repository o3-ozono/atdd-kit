...
- [ ] [regression] AT-001: Execution Mode 節の Review step bullet がレガシー記述を含まず現行実装を記述する
...
- [ ] [regression] AT-002: mermaid 図と導入文が Scout / Generate / Review / Verify / Aggregate を描く
...
- [ ] [regression] AT-003: 旧機構（固定 roster / serial / 47 基準）前提の記述が workflow-detail.md のどこにも残らない
...
- [ ] [regression] AT-004: docs-only 変更でも CHANGELOG 更新と patch version bump を伴う
...
- [ ] [regression] AT-005: 実装と Non-Goals 対象ファイルに変更が波及していない
