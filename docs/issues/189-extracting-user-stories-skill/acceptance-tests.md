...
- [ ] [green] AT-001: skill 実行で PRD から US が生成される
...
- [ ] [green] AT-002: skill が Story 候補を 1 回のメッセージで一括提示する
...
- [ ] [green] AT-003: SKILL.md は 200 行以内
...
- [ ] [green] AT-004: SKILL.md が出力言語を日本語に固定するルールを含む
...
- [ ] [green] AT-005: 出力に `As a [...]` パターンが現れない
