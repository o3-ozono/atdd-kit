...
- [x] [green] [regression] AT-369-1: 4 技法 doc が一次情報付きで存在する
...
- [x] [green] [regression] AT-369-2: 各技法 doc が統一 5 フィールドを備える
  - Given: 4 技法 doc
...
- [x] [green] [regression] AT-369-3: 共通原則が独立 doc として存在し各技法から参照される
  - Given: 実装完了後のカタログ
...
- [x] [green] [regression] AT-369-4: SKILL.md はマッピング参照のみを持ち詳細は doc に委ねる
...
- [x] [green] [regression] AT-369-5: 原典記述と独自整理の境界が判別できる
...
- [x] [green] [regression] AT-369-6: 構造検証 BATS がカタログのファイル欠落・フィールド抜けを検出する
...
- [x] [green] [regression] AT-369-7: version と CHANGELOG が規約通り一貫する
