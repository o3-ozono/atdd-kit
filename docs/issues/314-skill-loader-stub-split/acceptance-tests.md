...
- [x] [green] AT-314-1: skill-loader-split.md に Split Pattern 節と stub/分離の基準が存在する
...
- [x] [green] AT-314-2a: Skill Inventory 表が全 20 SKILL.md を網羅し行数が実測と一致する
...
- [x] [green] AT-314-2b: 逼迫度しきい値が明示され各 Skill がランク分類されている
...
- [x] [green] AT-314-2c: session-start の pin 未設置が finding として記録されている
...
- [x] [green] AT-314-3a: Impact Analysis が 3 観点を影響＋対応方針で整理している
...
- [x] [green] AT-314-3b: string-pin 移行ルール（両 pin 棚卸し＋@covers 広域化）が明記されている
...
- [x] [green] AT-314-4: autopilot 先例（#283/#304）の分離実例が表で示されている
...
- [x] [green] AT-314-5: Pin Operation 節が DEVELOPMENT.md ルールを引用し stub/detail 双方の pin 方針を述べる
...
- [x] [green] AT-314-6: Rollout Plan が逼迫度降順で派生 Issue 計画を示す
...
- [x] [green] AT-314-CS1a: skill-loader-split.md が Loaded-by メタコメントで始まる
...
- [x] [green] AT-314-CS1b: docs/methodology/README.md に skill-loader-split.md が登録されている
...
- [x] [green] [regression] AT-314-CS2: 本 Issue の diff が SKILL.md を 1 行も変更しない
...
- [x] [green] [regression] AT-314-CS3a: skill-loader-split.md に日本語文字が含まれない
...
- [x] [green] [regression] AT-314-CS3b: skill-loader-split.md の `*.ja.md` 翻訳が存在しない
