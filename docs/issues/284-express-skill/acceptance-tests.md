...
- [ ] [planned] AT-001: express は明示コマンドでのみ発動し、Issue なしでは起動エラーになる
...
- [ ] [planned] AT-002: ユーザの明示的承認なしには開始されない
...
- [ ] [planned] AT-003: OK/NG 基準が文書化され、迷ったらフルフローへ案内される
...
- [ ] [planned] AT-004: express は中間成果物を一切作らない
...
- [ ] [planned] AT-005: express PR には `express-mode` ラベルと理由セクションが必ず付く
...
- [ ] [planned] AT-006: skill-gate が express 経路を正規ルートとして認識する
...
- [ ] [planned] AT-007: diff が適用基準を超えたら express を中断しフルフローへ切り替える
  - Given: `skills/express/SKILL.md`
...
- [ ] [planned] AT-008: CI は省略されず、merge は常に人間が行う
...
- [ ] [planned] AT-009: 対象が atdd-kit 自身なら version bump + CHANGELOG は省略不可
