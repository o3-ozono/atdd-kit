...
- [ ] [planned] AT-289-1: AT-284 AT-010 が完全一致ピンではなく履歴事実＋最新リリース見出し整合で検証する
...
- [ ] [planned] AT-289-2: AT-271 AT-005 が履歴事実を維持したまま完全一致ピンを最新リリース見出し整合へ置換する
...
- [ ] [planned] AT-289-3: AT-006 の構造を変えずに全 suite 再帰実行が green になる
...
- [ ] [planned] AT-289-4: 両 SKILL.md に時点依存ピン禁止のガイダンスが明文化されている
...
- [ ] [planned] AT-289-5: 現状および将来の version bump 後も対象 AT が green を維持する
