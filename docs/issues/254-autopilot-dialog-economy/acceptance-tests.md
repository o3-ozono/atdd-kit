...
- [ ] [planned] AT-001: SKILL.md の Dialog economy セクションに「聞くべき」基準が明文化されている
...
- [ ] [planned] AT-002: 逐次 ok 確認の禁止と一括提示・一括承認が明文化されている
...
- [ ] [planned] AT-003: 指針が autopilot SKILL.md（orchestrator）に置かれ、適用範囲が autopilot 中の人間向け対話全般である
...
- [ ] [planned] AT-004: 新セクション追加後もゲート数の契約が変わっていない
...
- [ ] [planned] AT-005: "one question at a time" は通常フローで維持され、オーバーライドは autopilot 側にのみ明記される
...
- [ ] [planned] AT-006: ピンテスト群が `tests/test_autopilot_skill.bats` に存在し、スイート全体が green
