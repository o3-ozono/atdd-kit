...
| [prioritization.md](prioritization.md) | Feature prioritization methodology — MoSCoW-derived 5-stage labels, impact×effort 2-axis judgment, anti-patterns, discard handling |
...
| [a11y-test-taxonomy.md](a11y-test-taxonomy.md) | a11y test method taxonomy — 3-way split (Automated/Static, Automated/Interactive, Manual), "automated green ≠ a11y achieved" with Playwright/Deque citations, WCAG 2.2 AA / JIS X 8341-3:2016 applicability criteria, and the separate-axis distinction from SC-level triage (#372) |
| [testing/ui-e2e-foundations.md](testing/ui-e2e-foundations.md) | Platform-independent UI/E2E test principles (waiting, locators, structure, granularity) and an execution-ready LLM rule set, inherited by referencing from the web/ios/discord addons (#371) |
