...
| [autopilot-iron-law.md](autopilot-iron-law.md) | The autopilot Iron Law (AL-1…AL-6) — overrides the standard Iron Law while autopilot (`converging-deliverables`) runs |
